...
function seg = chenvese(I,mask,num_iter,mu,lambda1,lambda2, vi,reverseColor,method)
        ...
        %-- Main loop
          for n=1:num_iter
              ...
              for i=1:layer
                  ...
                  force_image=-lambda1*(L-c1).^2+lambda2*(L-c2).^2+force_image; 
          ...
          %make mask from SDF
          seg = (reverseColor*phi0)<=0; %-- Get mask from levelset
